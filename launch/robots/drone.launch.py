...
def generate_launch_description():
    ...
    '''if "GZ_SIM_RESOURCE_PATH" in os.environ:
        ...
        # Set GZ_SIM_RESOURCE_PATH directly to the 'models' folder inside ano package
    gz_sim_resource_path = os.path.join(pkg_iris, "models")
    ...
    # Ensure SDF_PATH includes GZ_SIM_RESOURCE_PATH for sdformat_urdf usage
    # Manually create or append, no environment check needed here
    existing_sdf_path = os.environ.get("SDF_PATH", "")
    if existing_sdf_path:
        new_sdf_path = existing_sdf_path + ":" + gz_sim_resource_path
    else:
        new_sdf_path = gz_sim_resource_path
    ...
    sdf_file = os.path.join(
        pkg_iris, "models", "iris_with_gimbal", "model.sdf"
    )
        ...
        parameters=[
            {
                "config_file": os.path.join(
                    pkg_iris, "config", "iris_bridge.yaml"
                ),
